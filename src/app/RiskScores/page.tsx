...
const RiskScores = () => {
  ...
  useEffect(() => {
    ...
    const handleMentalUpdate = (event: CustomEvent) => {
      const { prediction } = event.detail;
      setMentalRiskData(prediction);
    };
    ...
    window.addEventListener(
      "mentalAssessmentUpdated",
      handleMentalUpdate as EventListener
    );
        ...
        <div className="risk-score-card">
          ...
          <div className="mental-risk-display">
            <div
              ...
              style={{
                border: `20px solid ${mentalRiskColor}`,
