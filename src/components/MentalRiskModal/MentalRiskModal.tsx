                ...
                <form className="modal-form" onSubmit={handleSubmit}>
                    <div className="mb-3">
                        <label className="form-label">
                            How much control do you feel you have over your daily tasks and responsibilities? (1-5)
                        </label>
                        <select
                    ...
                    <div className="mb-3">
                        <label className="form-label">
                            How often do you catch yourself thinking negatively about your abilities or self-worth?
                        </label>
                        <select
                            className="form-control"
                    ...
                    <div className="mb-3">
                        <label className="form-label">
                            How often do you procrastinate tasks because you feel overwhelmed or stressed?
                        </label>
                        <select
                            className="form-control"
                    ...
                    <div className="mb-3">
                        <label className="form-label">
                            How much does your job or work environment contribute to your stress? (1-5)
                        </label>
                        <select
                            className="form-control"
                            name="Work_Stress"
                    ...
                    <div className="mb-3">
                        <label className="form-label">
                            Over the past two weeks, how often have you had trouble concentrating on things, such as reading or work tasks?
                        </label>
                        <select
                            className="form-control"
                            name="Productivity"
                    ...
                    <div className="mb-3">
                        <label className="form-label">
                            Over the past two weeks, how often have you had thoughts that you would be better off dead, or hurting yourself in some way?
                        </label>
                        <select
                            className="form-control"
                    ...
                    <div className="mb-3">
                        <label className="form-label">
                            How much free time do you have each day to focus on self-care or relaxation? (minutes)
                        </label>
                        <input
                            className="form-control"
                            type="number"
